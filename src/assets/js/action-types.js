export const SET_MINIMUM_STAR_FILTER = "set_minimum_star_filter";
export const SET_MAXIMUM_STAR_FILTER = "set_maximum_star_filter";
export const CLEAR_STAR_FILTERS      = "clear_star_filters";
